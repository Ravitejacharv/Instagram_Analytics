...
/*
Output:- 5 oldest users of the Instagram are
	username		| 			created_at
--------------------|--------------------------
...
/*
Output:- Following list are the users who have never posted a single photo on Instagram.
id		|		username
--------|---------------------------
5		|	Aniya_Hackett
...
/*
Output:- Winner of the contest and their details.
...
/*
Output:- Top 5 most commonly used hashtags are as mentioned below
tag_name		|		num_tags
----------------|---------------------
smile			|		59
beach			|		42
...
/*
Output:- There are more number of users registered on Thursday and Sunday with 16 number of users 
and Saturday is the least with 12 no's.
weekday		|	num_users
------------|-----------------
	3		|	16
	6		|	16
...
/*
Output:- Average photos per user is 3.4730
*/
...
#7 Provide data on users (bots) who have liked every single photos on the site (since any normal user would not be able to do this).
